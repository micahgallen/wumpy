...
const chatCommand = require('./commands/core/chat');
...
const lootCommand = require('./commands/core/loot');
...
const lightCandlesCommand = require('./commands/interactions/lightCandles');
...
registry.registerCommand(chatCommand);
...
registry.registerCommand(lootCommand);
...
registry.registerCommand(lightCandlesCommand);
...
const gotoCommand = require('./commands/admin/goto');
...
registry.registerCommand(gotoCommand);
